...
AS 
	-- [v0.9.3524.1] - License, Code, & Docs: https://github.com/overachiever-productions/dda/ 
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DECLARE @CurrentVersion varchar(20) = N'0.9.3524.1';
DECLARE @VersionDescription nvarchar(200) = N'Pre 1.0 Test Build.';
