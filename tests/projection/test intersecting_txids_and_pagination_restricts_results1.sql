...
CREATE OR ALTER PROCEDURE [projection].[test intersecting_txids_and_pagination_restricts_results]
AS
BEGIN
  	-----------------------------------------------------------------------------------------------------------------
	-- Arrange:
	...
	EXEC dda.[get_audit_data]
		@StartTransactionID = N'2021-145-00007912', 
		@EndTransactionID =   N'2021-145-99999999', 
		@FromIndex = 1, 
		@ToIndex = 2;
