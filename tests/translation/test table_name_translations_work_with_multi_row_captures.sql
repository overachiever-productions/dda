...
CREATE OR ALTER PROCEDURE [translation].[test table_name_translations_work_with_multi_row_captures]
AS
BEGIN
  	-----------------------------------------------------------------------------------------------------------------
	-- Arrange:
	...
	(
		...
		31407, 
		3, 
		N'[{"key":[{"CalendarNumber":0,"Date":"2018-10-10T00:00:00"}],"detail":[{"Description":{"from":"xxddxfgb","to":"xxddxfgbs"}}]},{"key":[{"CalendarNumber":1,"Date":"2018-10-10T00:00:00"}],"detail":[{"Description":{"from":"adlkliull","to":"--37--"}}]},{"key":[{"CalendarNumber":2,"Date":"2018-10-10T00:00:00"}],"detail":[{"Description":{"from":"asdxsadfsdafsad","to":""}}]}]' 
	);
	...
	-----------------------------------------------------------------------------------------------------------------
	 ...
	 DECLARE @expectedJSON nvarchar(MAX) = N'[{"key":[{"CalendarNumber":0,"Date":"2018-10-10T00:00:00"}],"detail":[{"Description":{"from":"xxddxfgb","to":"xxddxfgbs"}}]},{"key":[{"CalendarNumber":1,"Date":"2018-10-10T00:00:00"}],"detail":[{"Description":{"from":"adlkliull","to":"--37--"}}]},{"key":[{"CalendarNumber":2,"Date":"2018-10-10T00:00:00"}],"detail":[{"Description":{"from":"asdxsadfsdafsad","to":""}}]}]';
