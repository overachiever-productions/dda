...
CREATE OR ALTER PROCEDURE [translation].[test column_name_translations_work_with_value_translations]
AS
BEGIN
  	-----------------------------------------------------------------------------------------------------------------
	-- Arrange:
	...
	VALUES	(
		...
		N'Calendar77' -- translation_value - sysname
	);
	...
	DECLARE @expectedJSON nvarchar(MAX) = N'[{"key":[{"Pointer_to_the_CalendarNames_table":"Calendar77","Date":"2018-10-10T00:00:00"}],"detail":[{"Description":{"from":"xxddxfgb","to":"xxddxfgbs"}}]}]';
