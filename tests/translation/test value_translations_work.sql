...
CREATE OR ALTER PROCEDURE [translation].[test value_translations_work]
AS
BEGIN
  	-----------------------------------------------------------------------------------------------------------------
	-- Arrange:
	...
	(
		...
		34827897, 
		1, 
		N'[{"key":[{"bigid":10060000}],"detail":[{"some_data":{"from":"test","to":"test_7"}}]}]' 
	);
	...
	-----------------------------------------------------------------------------------------------------------------
	 ...
	 DECLARE @expectedJSON nvarchar(MAX) = N'[{"key":[{"bigid":10060000}],"detail":[{"some_data":{"from":"test","to":"email-test"}}]}]';
