...
CREATE OR ALTER PROCEDURE [translation].[test foreign_key_translations_work]
AS
BEGIN
  	-----------------------------------------------------------------------------------------------------------------
	-- Arrange:
	...
	DECLARE @expectedJSON nvarchar(MAX) = N'[{"key":[{"row_id":5450}],"detail":[{"row_id":5450,"entry_date":"2021-03-08T17:55:01.240","operation_type":"DELETE LOGIN","batch_size":399,"login_creation_time_ms":999,"count_of_sys_principals":-999}]}]';
